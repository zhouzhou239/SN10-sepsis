...
scRNA3<-readRDS("Step6_Macrophage.rds")
...
#输出
write.table(gsea.re1, 'gsea_Patients_Healthy_hallmark_Macrophage.xls', sep = '\t', row.names = FALSE, quote = FALSE)
...
#输出
save(gsea.re1,g1,gsea.re2,g2,file = 'gsea_Patients_Healthy_Macrophage.RData')
#画图
...
ggsave(p1, filename = 'GSEA_Patients_Healthy_Macrophage.pdf', width =6, height =0.9)