...
scRNA3<-readRDS("Step6_T_cells.rds")
...
#输出
write.table(gsea.re1, 'gsea_Patients_Healthy_hallmark_T_cells.xls', sep = '\t', row.names = FALSE, quote = FALSE)
...
#输出
save(gsea.re1,g1,gsea.re2,g2,file = 'gsea_Patients_Healthy_T_cells.RData')
#画图
...
ggsave(p1, filename = 'GSEA_Patients_Healthy_T_cells.pdf', width =6, height =2)